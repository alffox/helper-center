/*function builder() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $(".app_container").prepend('<div style="display: block; order: 9999;"><div class="LRbl LRbm LRbn LRbo LRbp LRbq LRat LRbr LRbs"><div class="app_view_outer" style="display: block;"><div class="iframe_app_view_wrapper"><header class="app_header"><img class="logo" src="https://raw.githubusercontent.com/alffox/helper-center/master/app/images/icon-32.png?sanitize=true"><h3 class="title">Helper Center</h3></header><div class="app_view_wrapper"><div class="app_view apps_ticket_sidebar box" id="app">\
...
/*document.addEventListener('DOMContentLoaded', function() {
    var scriptUrl = 'https://cdns.gigya.com/js/gigya.js?apiKey=' + [[${gigyaApiKey}]];
    $.getScript(scriptUrl, function () {}).done(function () {
        //Custom code using gigya js library
    });
});*/
